...
public:
    ...
    */
    ...
    //! Member iterator
    /*! \pre IsObject() == true */
    MemberIterator MemberBegin()            { return MemberIterator(GetMembersPointer()); }
    //! \em Past-the-end member iterator
    /*! \pre IsObject() == true */
    MemberIterator MemberEnd()              {  return MemberIterator(GetMembersPointer() + data_.o.size); }
    ...
    */
    ...
    /*! This version has better performance with supplied length, and also support string containing null character.
        ...
        \return The value itselXf for fluent API.
