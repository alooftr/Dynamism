...
bool ImGui::BeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddText(g.Font, 13.f, child_bb + ImVec2(ImGui::GetWindowWidth() / 2 - 20, -7), ImColor(255, 255, 255, 255), name);
   /* auto tSize = ImGui::CalcTextSize(name);
    parent_window->DrawList->AddRectFilled(ImVec2(parent_window->DC.CursorPos.x, parent_window->DC.CursorPos.y), ImVec2(child_bb.x + 115, parent_window->DC.CursorPos.y + 3), ImColor(20, 90, 200, 255));
    parent_window->DrawList->AddRectFilled(ImVec2(parent_window->DC.CursorPos.x + ImGui::GetWindowWidth() / 2 - 15 + tSize.x, parent_window->DC.CursorPos.y), ImVec2(child_bb.x + 280, parent_window->DC.CursorPos.y + 3), ImColor(20, 90, 200, 255));*/
