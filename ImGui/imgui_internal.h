...
namespace ImGui
{
    ...
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& size, const ImVec2& uv0, const ImVec2& uv1, const ImVec2& padding, const ImVec4& bg_col, const ImVec4& tint_col, bool preview = false, const ImVec4& skin_rarity = ImVec4 (1.f,0,0, 1.f));
