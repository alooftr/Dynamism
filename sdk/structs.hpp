...
{
public:
    OFFSET(CUtlVector<IRefCounted*>, GetCustomMaterials, 0x14);
    OFFSET(CUtlVector<IRefCounted*>, GetVisualsDataProcessors, 0x230);
};
...
{
public:
    NETVAR(CEconItemView, GetEconItemView, "CBaseAttributableItem", "m_Item");
...
public:
    ...
    NETVAR(int, Explode, crypt_str("CBaseCSGrenadeProjectile"), crypt_str("m_nExplodeEffectTickBegin"));
    ...
    AnimationLayer* get_animlayers(int idx);
