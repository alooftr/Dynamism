...
void ConVar::sSetValue(const char *value)
{
	ConVar *var = (ConVar *)m_pParent;
	var->InternalSetValue(value);
}

void ConVar::fSetValue(float value)
{
	ConVar *var = (ConVar *)m_pParent;
	var->InternalSetFloatValue(value);
}

void ConVar::bSetValue(bool value)
{
	ConVar* var = (ConVar*)m_pParent;
	var->InternalSetFloatValue(value);
}

void ConVar::iSetValue(int value)
{
	ConVar *var = (ConVar *)m_pParent;
	var->InternalSetIntValue(value);
}

void ConVar::cSetValue(Color value)
{
	ConVar *var = (ConVar *)m_pParent;
