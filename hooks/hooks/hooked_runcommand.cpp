...
{
	static auto original_fn = prediction_hook.GetOriginal <RunCommand_t> ();
...
{
	static auto original_fn = prediction_hook.GetOriginal <InPrediction_t> ();
...
{
	static auto original_fn = client_hook2.GetOriginal <WriteUsercmdDeltaToBuffer_t> ();
